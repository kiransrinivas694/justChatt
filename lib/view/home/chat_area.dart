            ...
            child: Container(
              ...
              child: Obx(() => ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      print(
                          "printing logged email -> ${controller.loggedEmail}");
                      print(
                          "printing logged email -> ${controller.loggedEmail == controller.messagesList[index].senderMail}");
                      return Container(
                        width: double.infinity,
                        ...
                        child: Column(
                          crossAxisAlignment: controller.loggedEmail ==
                                  controller.messagesList[index].senderMail
